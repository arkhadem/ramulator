...
void declare_configuration(const Config &configs) {
    ...
    ramulator::core_configs[core_type_t::SILVER].l2_cache_config.size = 1 << 17;
    ramulator::core_configs[core_type_t::SILVER].l2_cache_config.assoc = 1 << 3;
    ...
    ramulator::core_configs[core_type_t::GOLD].l2_cache_config.size = 1 << 18;
    ramulator::core_configs[core_type_t::GOLD].l2_cache_config.assoc = 1 << 3;
...
int main(int argc, const char *argv[]) {
    if (argc < 2) {
        printf("Usage: %s <configs-file> --mode=cpu,dram [--stats <filename>] "
