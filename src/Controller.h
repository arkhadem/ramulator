...
protected:
    ...
    ScalarStat req_queue_full_stalls;
...
public:
        ...
        , cmd_trace_files(channel->children.size())
    {
        ...
        req_queue_full_stalls
            .name("req_queue_full_stalls_" + to_string(channel->id))
            .desc("number of cycles this channel's queue has been full.")
            .precision(0);
