...
make clean
make -j7 CFLAGS='-DEXE_TYPE=INORDER_EXE -DISA_TYPE=LIME_ISA -DLANES_PER_CB=2048 -DLANES_PER_SA=64'
...
make clean
make -j7 CFLAGS='-DDEBUG -DEXE_TYPE=INORDER_EXE -DISA_TYPE=LIME_ISA -DLANES_PER_CB=2048 -DLANES_PER_SA=64'
